  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <form onSubmit={handleSubmit} className="surface relative w-full max-w-md p-6 shadow-xl sm:p-8">
        ...
        <div className="mt-6 border-t border-border pt-5 text-center"><Link href="/sobre" className="text-sm font-medium text-muted-foreground transition hover:text-primary">Sobre o ListaWeb</Link></div>
      </form>
    </div>
  );
}
